        ...
        <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-4">
                        <h1 class="m-0 site-logo"><a href="index.html">SIP</a></h1>
                    </div>
                    ...
                    <div class="col-8">
                        ...
                        <a href="#" class="d-inline-block d-lg-none site-menu-tog   gle js-menu-toggle float-right"><span class="icon-menu h3"></span></a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <?php if (session()->get('nama') == null) { ?>
                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay="">halo guest</h1>

                                <?php } else { ?>
                                    <h1 class="text-white" data-aos="fade-up" data-aos-delay=""> halo <?= session()->get('nama') ?></h1>
                                <?php } ?>

                                <p class="lead text-white" data-aos="fade-up" data-aos-delay="100">Wonderfull Baliku</p>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mb-5" data-aos="fade">
                    <div id="filters" class="filters text-center button-group col-md-7">
                        ...
                        <?php foreach ($destinasi as $dt) { ?>
                            <button class="btn btn-primary" data-filter=".<?= $dt['kategori'] ?>"><?= $dt['kategori'] ?></button>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div id="posts" class="row no-gutter">
                    ...
                    <?php foreach ($destinasi as $dt) { ?>
                        <div class="item <?= $dt['kategori'] ?> col-6 col-sm-6 col-md-6 col-lg-4 col-xl-4 mb-4">
                            <a href="images/<?= $dt['nama'] ?>" class="item-wrap fancybox">
                                <span class="icon-search2"></span>
                                <img class="img-fluid" src="upload/gambar/<?= $dt['nama'] ?>" style="height: 250px; width: 400px">
                            </a>
                        </div>
                    <?php } ?>
